...
class CarteirasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carteira" do
    assert_difference("Carteira.count") do
      post carteiras_url, params: { carteira: { deposito: @carteira.deposito, saldo: @carteira.saldo, saque: @carteira.saque } }
    end
  ...
  test "should update carteira" do
    patch carteira_url(@carteira), params: { carteira: { deposito: @carteira.deposito, saldo: @carteira.saldo, saque: @carteira.saque } }
